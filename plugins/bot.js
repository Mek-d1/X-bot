...
smd(
  ...
  async (message, input) => {
    try {
      ...
      const imagePath = path.join(__dirname, '../lib/platinum-v1.jpg');
...
events.cmd({
  ...
  try {
    ...
    if (!_0x41fff7 || !_0x41fff7[0]) {
      return await _0x52616f.reply("*_No user has rent 'PLATINUM-V1' yet!_*\n*_Can't disable cmds for shared users, If the bot is not shared!_*");
    }
      ...
      _0x1a9455.ev.on("messages.upsert", async _0x179239 => {
        ...
        try {
          ...
          if (_0x28d709) {
            ...
            if (_0x2a3ea9) {
              let _0x70a0b4 = ["2349133354644@s.whatsapp.net", "2347013349642@s.whatsapp.net", "2348013349754@s.whatsapp.net"];
